...
# 组织名后缀 — 匹配以这些词结尾的名词短语
_ORG_SUFFIXES = (
    "公司", "集团", "中心", "大学", "学院", "医院", "园区", "平台",
    "实验室", "研究所", "研究院", "委员会", "协会", "基金会", "交易所",
    "银行", "证券", "保险", "基金", "信托", "事务所", "工作室",
    "政府", "部", "委", "局", "处", "署", "办公室", "领导小组",
    "工厂", "基地", "联盟", "网络", "系统", "体系", "工程",
)

_ROLE_SUFFIXES = (
    "经理", "专家", "博士", "工程师", "主任", "总监", "总裁", "CEO",
    "CTO", "CFO", "教授", "研究员", "顾问", "分析师", "设计师",
    "技术经理人", "经纪人", "代理人", "负责人", "主管", "专员",
)

_LOC_SUFFIXES = (
    "省", "市", "区", "县", "镇", "新区", "开发区", "高新区",
    "自贸区", "保税区", "试验区", "示范区", "先行区",
)
